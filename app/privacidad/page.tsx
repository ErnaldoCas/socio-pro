        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6 space-y-6 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-600 ml-2">
              ...
              <li><strong>Datos de pago:</strong> el procesamiento lo realiza exclusivamente Mercado Pago — no almacenamos datos de tarjetas.</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>Si usas el plan Pro y agregas colaboradores, estos podrán ver y registrar información de tu negocio según los permisos que tú les asignes. Eres responsable de gestionar los accesos de tu equipo. Los colaboradores no pueden ver datos de otros negocios ni acceder a configuraciones sin permiso.</p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-600 ml-2">
              ...
              <li><strong>Eliminar</strong> tu cuenta y todos tus datos — contáctanos y lo procesamos en máximo 30 días.</li>
          ...
          <section>
            ...
            <p>Conservamos tus datos mientras tu cuenta esté activa. Si eliminas tu cuenta, tus datos se borran permanentemente en un plazo máximo de 30 días, excepto los que debamos conservar por obligaciones legales.</p>
          </section>
